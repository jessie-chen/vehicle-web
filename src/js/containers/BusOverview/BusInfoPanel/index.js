        ...
        return (
            <div>
                <div className="car_detail_panel">
                    <span className="bus-pic"><i className="bus-img"> </i></span>
                    <InfoBoxFrame size = "small" title = "详细车辆信息">
                        <div><span>{licence}<label>车牌:</label><i>粤B00102f</i></span> <span className="right-content">{dashboard}<label>当前时速:</label><i>3km/h</i></span></div>
                        <div><span>{licence}<label>编号:</label><i>026</i></span> <span className="right-content">{dashboard}<label>续驶里程:</label><i>12km/h</i></span></div>
                        <div><span>{licence}<label>状态:</label><i>运行中</i></span> <span className="right-content">{dashboard}<label>总里程:</label><i>50km</i></span></div>
                        <div><span>{licence}<label>类型:</label><i>飞驰11米氢燃料电池车</i></span></div>
                    </InfoBoxFrame>
                </div>
                <div className="history_panel">
                    <InfoBoxFrame size = "small" title = "历史动态">
                        <span className="history-title">车辆运行动态:</span>
